...
const Testimonial = () => {
  ...
  return (
    <div className={`bg-gradient-to-b from-green-50 to-white transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className="px-4 mx-auto max-pad-container py-14">
        {/* Header Section with fade-in and slide-down effect */}
        <div className={`text-center mb-16 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
          <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">
            What Our Vendors Say
          </h1>
          <div className="w-40 h-1 mx-auto mt-2 rounded bg-emerald-500"></div>
